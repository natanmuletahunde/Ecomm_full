    ...
    <form onSubmit={onSubmitHandler}>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        <div className=''>
              ...
              <select onChange={(e)=>setCategory(e.target.value)} className='px-3 py-2' name="" id="">
        ...
        <div className=''>
              ...
              <select  onChange={(e)=>setSubCategory(e.target.value)} className='px-3 py-2' name="" id="">
        ...
        <div>
          ...
          <input onChange={(e)=>setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' placeholder='25' type="Number" name="" id=""  />
        </div>
